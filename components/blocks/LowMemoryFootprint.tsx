      ...
      <section className={`generic-block faint ${styles.lmfBlock}`}>
        <div className={`mid ${styles.mid}`}>
          <div className={`left ${styles.left}`}>
            ...
            <p>
              Graphul's low memory footprint without a GC allows you to
              implement features without worrying about how much memory your
              application will use. This allows you to focus on your application
              and its business logic, rather than technical particularities.
            </p>
          </div>
